...
* `https://github.com/constXife/caddy-security` => `https://github.com/anonymous/caddy-security`
* `https://github.com/constXife/go-authcrunch` => `https://github.com/anonymous/go-authcrunch`
...
Next, modify `go.mod` in `github.com/constXife/caddy-security`. Include
...
```
module github.com/constXife/caddy-security

go 1.21

require (
    github.com/constXife/go-authcrunch v1.1.4
)

replace github.com/constXife/go-authcrunch v1.1.4 => /home/greenpau/dev/go/src/github.com/constXife/go-authcrunch
```

Alternatively:

```bash
go mod edit -replace github.com/constXife/go-authcrunch@v1.1.4=/home/greenpau/dev/go/src/github.com/constXife/go-authcrunch@v1.0.48
```
...
```bash
        @mkdir -p ../xcaddy-$(PLUGIN_NAME) && cd ../xcaddy-$(PLUGIN_NAME) && \
                ...
                --with github.com/constXife/caddy-security@$(LATEST_GIT_COMMIT)=$(BUILD_DIR) \
                --with github.com/constXife/go-authcrunch@v1.1.4=/home/greenpau/dev/go/src/github.com/constXife/go-authcrunch
```
